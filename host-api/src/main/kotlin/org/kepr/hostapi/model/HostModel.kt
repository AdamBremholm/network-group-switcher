...
data class HostModel(val id: Long?, @field:NotBlank(message = EMPTY_ADDRESS_NOT_ALLOWED) val address: String, @field:NotBlank(message = EMPTY_NAME_NOT_ALLOWED) val name: String, @field:NotBlank(message = EMPTY_ALIAS_NOT_ALLOWED) val alias: String) {
